...
export const PhotographerModal = () => {
  ...
  return (
      <Modal
          title="Photographers and cameramans"
          className="xl:max-w-[1100px]"
          isOpen={photographerModal.isOpen}
          onClose={photographerModal.onClose}
      >
        <div className="flex flex-col border-t border-t-[rgba(160,126,98,0.30)] pt-4">
          <p className="text-[12px] text-[#594636] leading-[160%] font-medium">
            -Choose one to three persons from the list below. We will introduce one to you according to your preference
            based on their availability.
          </p>
          <p className="text-[12px] text-[#594636] leading-[160%] font-medium">
            -If you could not find that person, inform us through whatsapp or vip+ . We will introduce to you the required
            person.
          </p>

          <div className="relative mt-[80px]">
            <div className="flex flex-col md:border border-[rgba(160,126,98,0.50)] relative z-10">
              <div className="absolute -top-[40px] md:-top-[60px] left-1/2 transform -translate-x-1/2 z-20">
                <Image
                    width={99}
                    height={99}
                    alt={photographer.fullname}
                    src={photographer.avatar || "/placeholder.svg"}
                    className="mx-auto w-16 h-16 md:w-[99px] md:h-[99px] object-cover"
                />
              </div>

              <div className="flex flex-col mt-[60px] md:mt-[80px] text-center">
                <h2 className="text-[20px] lg:text-[34px] text-[#594636] capitalize font-normal">
              ...
              <div className="grid md:grid-cols-2 gap-2 mt-4 md:p-4">
                ...
                <div className="flex gap-2 items-center">
                  ...
                  <span className="text-xs font-semibold capitalize text-[#594636]">
                  {photographer.quadcopter ? <Check size={16} /> : <RiCloseLine className="w-4 h-4" />}
                </span>
                </div>
              </div>
