...
export const NextTours = ({
    ...
    const firstPart = next2monthTours.slice(0, 3); // ۴ آیتم اول
    const secondPart = next2monthTours.slice(3); // باقی آیتم‌ها
