  ...
  return (
    <div className=" px-4 pt-4 pb-2 md:pb-6 bg-white">
      <div className="flex flex-col">
        ...
        <h2 className="text-base md:text-[22px] font-bold text-[#594636] mt-2 md:mt-4">{title}</h2>
        ...
        <div className="flex items-center justify-center ">
          <Link href={``} title={title}>
            <span className="text-[14px] md:text-[15px] capitalize font-semibold text-[#594636] ">
              see detail
            </span>
          </Link>
        </div>
