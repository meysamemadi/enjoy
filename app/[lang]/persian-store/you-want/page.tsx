...
const Page = async ({
    ...
    const pages = [{ name: "say what you want", href: "", current: true }];
        ...
        <div className='bg-white px-4 py-6  xl:py-[40px] xl:px-[94px]'>
          ...
          <div className='flex flex-col'>
              ...
              <div className=' hidden md:block bg-[#F8F3EF] p-4 xl:px-6 py-3 opacity-80'>
               ...
               the following form is for announcing your (say what you want ) and we will contact you after registering the form.
                </p>
              </div>
