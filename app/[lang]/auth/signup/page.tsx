...
export default function Dashboard() {
  return (
    <div className="w-full lg:min-h-[600px] xl:min-h-[800px] flex flex-col lg:flex-row bg-[#FAF5EF] ">
      <div className="flex items-center justify-center py-12 w-full lg:w-1/2 order-2 lg:order-1">
        <div className="mx-auto grid w-[350px] gap-6 bg-white lg:bg-inherit p-4   relative   -mt-[150px] md:mt-auto md:h-full  ">
          <Logo />
      ...
      <div
        className={cn(
          style.login_image,
          " w-full lg:w-1/2 order-1 lg:order-2 min-h-[196px] "
        )}
      >
