...
const MainWebinar = ({ title, type, subject, langs }: MainWebinarProps) => {
        ...
        <div className="bg-white flex flex-col justify-center items-center md:hidden">
          ...
          <div className="flex justify-center gap-2 text-white mb-6">
            <div
              className={cn(
                Messina_Serif.className,
                "text-white font-semibold text-[10px] p-2 bg-[#33281F80]/50"
              )}
            >
              Lang: {langs}
            </div>
          ...
          <Link
            className="py-4 px-[48px] bg-[#497D59] text-white mb-4 capitalize"
            href={"/"}
          >
            Register
          </Link>
