...
export const AccommodationItem = ({
    ...
    return (
        <div
            className="flex w-full h-full md:max-h-[332px] flex-col md:flex-row p-2 md:p-6 gap-2 md:gap-4 aspect-[1/2.5] md:aspect-video bg-white">

            <div className="grid grid-rows-2 gap-1 w-full md:w-1/2 min-h-[132px]">
                <div className=" relative">
                    <Link href={`/${lang}/have-your-own-trip/accommodation/${id}`}>
                        {images[0] && <Image
                            fill
                ...
                {images[1] && <div className="flex flex-row gap-1">
                    ...
                    <div className="w-1/2 md:w-[40%] relative">
                        {images[2] &&
                            <Link href={`/${lang}/have-your-own-trip/accommodation/${id}`}><Image
                                fill
                                className=" w-full h-full object-center object-cover"
                                src={images[2]}
                                alt="ssss"
          ...
          <span className=" text-[#259F82] text-lg font-semibold">
            ...
            Price per night
                ...
                <Separator/>
                <Link href={`/${lang}/have-your-own-trip/accommodation/${id}`}
                      className="bg-inherit hover:text-[#F07148] rounded-none text-[#594636] text-sm leading-normal font-semibold text-center w-full capitalize opacity-80">
                    see details
                </Link>
            </div>
        </div>
