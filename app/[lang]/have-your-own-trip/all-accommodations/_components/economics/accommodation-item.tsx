  ...
  return (
    <div className="flex w-full h-full md:max-h-[332px] flex-col md:flex-row p-2 md:p-6 gap-2 md:gap-4 aspect-[1/2.5] md:aspect-video bg-white">
      ...
      <div className="flex flex-col w-full gap-2 md:w-1/2 space-y-2">
        ...
        <Separator />
        <Link href={`accommodation/${id}`} className=" bg-inherit hover:text-[#F07148] rounded-none text-[#594636] text-sm leading-normal font-semibold text-center w-full capitalize opacity-80">
          see details
        </Link>
      </div>
    </div>
